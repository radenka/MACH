...
def load_SMARTS_and_atom_types():
    ...
    # works fine for MACH, SMARTS file is not detected if only basename of directory containing io.py is defined
    # ok when using absolute path, works for attyc, too
    current_dir = os.path.dirname(__file__)
    # print('Current directory of io.py:', current_dir)
